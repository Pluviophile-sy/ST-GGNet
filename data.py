...
train_num_dict = {
    '1': [6631, 18649, 2099, 3064,1345,5029,1330,3682,947],
    ...
    '4':[20, 37, 19, 13, 26, 39, 35, 112, 62, 32, 10, 19, 9, 10, 72, 18],
...
class_name_dict = {
    ...
    '4':['Brocoli_green_weeds_1','Brocoli_green_weeds_2','Fallow','Fallow_rough_plow',
...
def load_data(dataID=1, fixed=False):
    ...
    #X = sio.loadmat('Dataset/Houston.mat')['Houston']
    ...
    if fixed:
        ...
        #Y = sio.loadmat('Dataset/Houston_gt.mat')['Houston_gt']
...
def draw_false_color(dataID=1):
    ...
    plt.imsave('./' + data_name_dict[str(dataID)] + '_rgb.png', X)
